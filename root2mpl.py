...
class MplObject1D(object):
	...
	def __init__(self, roothisto):
		...
		# bin content
		self.y = np.array([roothisto.GetBinContent(i) for i in xrange(1, roothisto.GetNbinsX() +1)])
		# bin content
		self.yerr = np.array([roothisto.GetBinError(i) for i in xrange(1, roothisto.GetNbinsX() +1)])
		# lower bin error
		self.yerrl = np.array([roothisto.GetBinErrorLow(i) for i in xrange(1, roothisto.GetNbinsX() +1)])
		# upper bin error
		self.yerru = np.array([roothisto.GetBinErrorUp(i) for i in xrange(1, roothisto.GetNbinsX() +1)])
