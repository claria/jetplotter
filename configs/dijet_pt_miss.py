...
def get_config():
    ...
    for rap_bin in rap_bins:
        ...
        config['objects']["miss_ptavg"] = {
            "input": "~/dust/dijetana/ana/CMSSW_7_2_3/response_study_smeared2_QCDMGP6.root?{0}/h_unf_pt_miss_ptavg".format(rap_bin), 
            "label": "MG+P6",
            "step": True, 
            "style": "line", 
            "x_err": True, 
        ...
        config["output_path"] = 'dijet_pt_miss_{0}.png'.format(rap_bin)
