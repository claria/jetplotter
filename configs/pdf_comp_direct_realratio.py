    ...
    for k, q2 in enumerate(q2s):
        for i, parton in enumerate(partons):
            ...
            config['minusone'] = ['ratio__{0}_totunc_to__{0}_totunc'.format(pdfset1), 
                                  'ratio__{0}_totunc_to__{1}_totunc'.format(pdfset2, pdfset1)
                                  ]

            config["plot_id"] =  [
                                    '_{0}_totunc'.format(pdfset1),'ratio__{0}_totunc_to__{0}_totunc'.format(pdfset1),
                                    '_{0}_totunc_line'.format(pdfset1),
                                    '_{0}_totunc'.format(pdfset2),'ratio__{0}_totunc_to__{1}_totunc'.format(pdfset2, pdfset1),
            ...
            config['ratio_copy'] = [
                                    ...
                                    ('_{0}_totunc'.format(pdfset2), '_{0}_totunc'.format(pdfset1)),
                                    ]
            ...
            config["objects"]["ratio__{0}_totunc_to__{1}_totunc".format(pdfset2, pdfset1)] = {
                "edgealpha": 1.0, 
                "style": "band", 
                "rasterized": False, 
                "capsize": 0, 
            ...
            config["output_path"] = 'pdfcomp_direct_realratio_{0}_{1}.png'.format(partons[i], q2)
