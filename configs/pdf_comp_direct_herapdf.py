...
def get_config():
    ...
    q2s = [1.9, 4.0, 10000]
    pdfset1 = "HERAPDF20_NLO_EIG"
    pdfset3 = "INCJETS_8TEV_EIG"
    pdfset2 = "HFTD_HERACMSTDJETS_V111E_EIG"
    pdfset4 = "HFTD_HERA_V111E_EIG"

    pdf_label1 = "HERAPDF2.0-NLO"
    pdf_label3 = "HERA + CMS INC JETS"
    pdf_label2 = "HERA + CMS Dijets"
    pdf_label4 = "HERA (Dijets Param.)"
    ...
    for k, q2 in enumerate(q2s):
        for i, parton in enumerate(partons):
            ...
            config["output_path"] = 'pdfcomp_direct_{0}_{1}_herapdf.png'.format(partons[i], q2)
