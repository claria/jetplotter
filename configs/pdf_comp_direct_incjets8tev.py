...
def get_config():
    ...
    q2s = [1.9, 4.0, 10000]
    pdfset1 = "INCJETS_8TEV_EIG"
    pdfset2 = "HFTD_HERACMSTDJETS_V111C_EIG"

    pdf_label1 = "HERA + CMS Incjets"
    ...
    for k, q2 in enumerate(q2s):
        for i, parton in enumerate(partons):
            ...
            config["ax_texts"] = [
                                  ...
                                  # {'s': ur'Simulation' , 'x': 0.055, 'y': 0.865, 'ha': 'left', 'va': 'top', 'size': 18, 'style':'italic'}, 

                                  ] 
            config["output_path"] = 'pdfcomp_direct_INCJETS8TEV_{0}_{1}.png'.format(partons[i], q2)
