...
def get_config():
    ...
    config['objects']["_yb1ys1"] = {
            ...
            "edgecolor": "auto", 
            "id": "_yb1ys1", 
            "input": "~/dust/dijetana/ana/CMSSW_7_2_3/resolution_QCDP8.root?yb1ys1/h2_GenVsRecoPtAvg", 
            "label": "__nolegend__", 
            "linestyle": "", 
            "marker": ".", 
            "step": False, 
    ...
    config['objects']["_yb2ys0"] = {
        ...
        "edgecolor": "auto", 
        "id": "_yb2ys0", 
        "input": "~/dust/dijetana/ana/CMSSW_7_2_3/resolution_QCDP8.root?yb2ys0/h2_GenVsRecoPtAvg", 
        "label": "__nolegend__", 
        "linestyle": "", 
        "marker": ".", 
        "step": False, 
    ...
    config['objects']["_yb0ys1"] = {
        ...
        "edgecolor": "auto", 
        "id": "_yb0ys1", 
        "input": "~/dust/dijetana/ana/CMSSW_7_2_3/resolution_QCDP8.root?yb0ys1/h2_GenVsRecoPtAvg", 
        "label": "__nolegend__", 
        "linestyle": "", 
        "marker": ".", 
        "step": False, 
    ...
    config['objects']["_yb0ys0"] = {
        ...
        "edgecolor": "auto", 
        "id": "_yb0ys0", 
        "input": "~/dust/dijetana/ana/CMSSW_7_2_3/resolution_QCDP8.root?yb0ys0/h2_GenVsRecoPtAvg", 
        "label": "__nolegend__", 
        "linestyle": "", 
        "marker": ".", 
        "step": False, 
    ...
    config['objects']["_yb1ys0"] = {
        ...
        "edgecolor": "auto", 
        "id": "_yb1ys0", 
        "input": "~/dust/dijetana/ana/CMSSW_7_2_3/resolution_QCDP8.root?yb1ys0/h2_GenVsRecoPtAvg", 
        "label": "__nolegend__", 
        "linestyle": "", 
        "marker": ".", 
        "step": False, 
    ...
    config['objects']["_yb0ys2"] = {
        ...
        "edgecolor": "auto", 
        "id": "_yb0ys2", 
        "input": "~/dust/dijetana/ana/CMSSW_7_2_3/resolution_QCDP8.root?yb0ys2/h2_GenVsRecoPtAvg", 
        "label": "__nolegend__", 
        "linestyle": "", 
        "marker": ".", 
        "step": False, 
    ...
    config["output_path"] = 'resolution_ptavg_crystalball_p8.png'
