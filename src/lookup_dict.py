...
lookup_dict = {
    ...
    'ax_texts': {
        ...
        '_cmss_': 'CMS Simulation?{"x": 0.0, "y":1.01, "va": "bottom", "ha" : "left"}',
        '_20fb_': '$19.7\\,\mathrm{fb}^{-1}$ (8TeV)?{"x": 1.0, "y":1.01, "va": "bottom", "ha" : "right"}',
        '_8tev_': '$\sqrt{s}$ = (8TeV)?{"x": 1.0, "y":1.01, "va": "bottom", "ha" : "right"}',
        '_yb0ys0_': '$0.0 \leq \, y_b < 1.0$\n$0.0 \leq \, y^* < 1.0$',
        '_yb1ys0_': '$1.0 \leq \, y_b < 2.0$\n$0.0 \leq \, y^* < 1.0$',
        '_yb2ys0_': '$2.0 \leq \, y_b < 3.0$\n$0.0 \leq \, y^* < 1.0$',
        '_yb0ys1_': '$0.0 \leq \, y_b < 1.0$\n$1.0 \leq \, y^* < 2.0$',
        '_yb0ys2_': '$0.0 \leq \, y_b < 1.0$\n$2.0 \leq \, y^* < 3.0$',
        '_yb1ys1_': '$1.0 \leq \, y_b < 2.0$\n$1.0 \leq \, y^* < 2.0$',
